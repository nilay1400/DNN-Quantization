...
csv_acc = "vgg11-0-15-fi50-ber00001.csv"

output_results_file = open("output_vgg11_0-15_ber00001", "w")
...
output_results_file = open("output_vgg11_0-15_ber00001", "a")
...
print('Accuracy Drop: %.4f %%' % (92.1875 - avg_accuracy))    
