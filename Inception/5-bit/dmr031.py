...
class DMR():
    ...
    def set(self):
        ...
        for iindex in range(self.flattened.shape[0]):
            ...
            # print(int_bin_list)
            int_bin_list[2] = int_bin_list[3]
            int_bin_list[1] = int_bin_list[3]       
            # print(int_bin_list)            
    ...
    def correct(self, int_value):
        ...
        if int_bin_list[2] != int_bin_list[3] or int_bin_list[1] != int_bin_list[3]:
            # print("no")
            n_zero = 0
            n_one = 0
            ...
            if int_bin_list[1] =='0': n_zero += 1
            else: n_one += 1
            if n_one > n_zero : int_bin_list[3] = '1'
            else: int_bin_list[3] = '0'
                        #int_bin_list[5] = '0'
            #option = ['0', '1']
