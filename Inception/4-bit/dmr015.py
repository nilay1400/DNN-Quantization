...
class DMR():
    ...
    def set(self):
        ...
        for iindex in range(self.flattened.shape[0]):
            ...
            # print(int_bin_list)
            int_bin_list[2] = int_bin_list[4]
            int_bin_list[3] = int_bin_list[4]       
            # print(int_bin_list)            
        ...
        modified_weights = flattened_copy.reshape(self.original_shape)
    ...
    def correct(self, int_value):
        ...
        int_bin_list = list(int_bin)
        # print(int_bin_list)
        if int_bin_list[0] == '1' or int_bin_list[1] == '1':
            int_bin_list[0] = '0'
            int_bin_list[1] = '0'
           
        if int_bin_list[2] != int_bin_list[4] or int_bin_list[3] != int_bin_list[4]:
            # print("no")
            n_zero = 0
            n_one = 0
            ...
            if int_bin_list[2] =='0': n_zero += 1
            else: n_one += 1
            if n_one > n_zero : int_bin_list[4] = '1'
            else: int_bin_list[4] = '0'
                        #int_bin_list[5] = '0'
            #option = ['0', '1']
