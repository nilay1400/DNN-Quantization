...
csv_acc = "resnet18-0-7-fi50-ber00001.csv"

# fault_dict = {"Iteration": [], "Layer": [], "Index": [], "Bit": []}
# csv_fault = "resnet18_fault_list50_ber003.csv"

output_results_file = open("output_resnet18_0-7_ber00001", "w")
...
output_results_file = open("output_resnet18_0-7_ber00001", "a")
...
print('Accuracy Drop: %.4f %%' % (90.8454 - avg_accuracy))    
