...
csv_acc = "resnet18-0-31-fi50-ber00001.csv"

output_results_file = open("output_resnet18_0-31_ber00001", "w")
...
output_results_file = open("output_resnet18_0-31_ber00001", "a")
...
model = torch.load('qresnet18-0-31.pth')
...
print('Accuracy Drop: %.4f %%' % (92.8185 - avg_accuracy))    
