...
csv_acc = "alex-0-15-fi50-ber00001.csv"

# fault_dict = {"Iteration": [], "Layer": [], "Index": [], "Bit": []}
# csv_fault = "resnet18_fault_list50_ber003.csv"

output_results_file = open("output_alex_0-15_ber00001", "w")
...
output_results_file = open("output_alex_0-15_ber00001", "a")
...
model = torch.load('qalex-0-15.pth')
...
print('Accuracy Drop: %.4f %%' % (94.9125 - avg_accuracy))    
